    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="widget">
                    <h3>Contact</h3>
                    <address>FPTAptech - Ton that thuyet</address>
                    <ul class="list-unstyled links">
                        <li><a href="tel://11234567890">+1(123)-456-7890</a></li>
                        <li><a href="tel://11234567890">+1(123)-456-7890</a></li>
                        <li><a href="mailto:info@mydomain.com">group2gmail.com</a></li>
                    </ul>
                </div> <!-- /.widget -->
            </div> <!-- /.col-lg-4 -->
            <div class="col-lg-4">
        ...
        <div class="row mt-5">
            ...
            <p>Copyright &copy;<script>document.write(new Date().getFullYear());</script>. All Rights Reserved &mdash; Designed with love by <a href="#">Group 2</a> 
                </p>
